...
- 作成日: 2026-07-04
- ステータス: 初版(全章完了)
- 参考資料: [調査レポート](../2026-07-03-typeless-clone-research.md) / [要件定義書](../2026-07-03-typeless-clone-requirements.md)
  - 両資料は参考であり本書を拘束しない。判断を変えた点は[第13章](#第13章-参考資料との差分サマリ)に列挙する
...
- **iOS / Windows / Web版** — 拡張余地としてのみ言及(第2章の構成はSTT/LLMパイプラインの将来共有を妨げない形にする)
...
### 12.2 Phase 1 — MVP実装+ドッグフード(目安3〜6週)
